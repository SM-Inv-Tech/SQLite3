...
{
    template<>
    struct is_error_code_enum<xhsqlite3::orm_error_code> : std::true_type
    {
    };

    inline std::error_code make_error_code(xhsqlite3::orm_error_code errorCode)
    {
        return std::error_code(static_cast<int>(errorCode), xhsqlite3::get_orm_error_category());
    }
}
#pragma once
...
namespace xhsqlite3
{
    ...
    /**
     *  This is class that tells `xhsqlite3` that type is nullable. Nullable types
    ...
    /**
     *  This is a specialization for std::shared_ptr. std::shared_ptr is nullable in xhsqlite3.
     */
    template<class T>
...
namespace xhsqlite3
{
     ...
     *  If you use `using namespace xhsqlite3` directive you an specify which `div` you call explicitly using  `::div` or `xhsqlite3::div` statements.
     */
    template<class L, class R>
        ...
        struct order_by_t : order_by_base, order_by_string
        {
            ...
            self collate_binary() const
            {
                ...
                res._collate_argument =
                        collate_constraint_t::string_from_collate_argument(xhsqlite3::internal::collate_argument::binary);
                return res;
            }
            ...
            self collate_nocase() const
            {
                auto res = *this;
                res._collate_argument =
                        collate_constraint_t::string_from_collate_argument(xhsqlite3::internal::collate_argument::nocase);
                return res;
            }
            ...
            self collate_rtrim() const
            {
                auto res = *this;
                res._collate_argument =
                        collate_constraint_t::string_from_collate_argument(xhsqlite3::internal::collate_argument::rtrim);
                return res;
            }
...
namespace xhsqlite3
{
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::acos(&Triangle::cornerA));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::acos<std::optional<double>>(&Triangle::cornerA));   //  decltype(rows) is std::vector<std::optional<double>>
     */
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::acosh(&Triangle::cornerA));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::acosh<std::optional<double>>(&Triangle::cornerA));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::asin(&Triangle::cornerA));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::asin<std::optional<double>>(&Triangle::cornerA));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::asinh(&Triangle::cornerA));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::asinh<std::optional<double>>(&Triangle::cornerA));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::atan(1));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::atan<std::optional<double>>(1));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::atan2(1, 3));   //  decltype(rows) is std::vector<double>
     */
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::atan2<std::optional<double>>(1, 3));   //  decltype(rows) is std::vector<std::optional<double>>
     */
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::atanh(1));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::atanh<std::optional<double>>(1));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::ceil(&User::rating));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::ceil<std::optional<double>>(&User::rating));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::ceiling(&User::rating));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::ceiling<std::optional<double>>(&User::rating));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::cos(&Triangle::cornerB));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::cos<std::optional<double>>(&User::rating));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::cosh(&Triangle::cornerB));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::cosh<std::optional<double>>(&User::rating));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::degrees(&Triangle::cornerB));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::degrees<std::optional<double>>(&User::rating));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::exp(&Triangle::cornerB));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::exp<std::optional<double>>(&User::rating));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::floor(&User::rating));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::floor<std::optional<double>>(&User::rating));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::ln(200));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::ln<std::optional<double>>(200));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::log(100));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::log<std::optional<double>>(100));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::log10(100));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::log10<std::optional<double>>(100));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::log(10, 100));   //  decltype(rows) is std::vector<double>
     */
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::log<std::optional<double>>(10, 100));   //  decltype(rows) is std::vector<std::optional<double>>
     */
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::log2(64));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::log2<std::optional<double>>(64));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::mod_f(6, 5));   //  decltype(rows) is std::vector<double>
     */
    template<class X, class Y>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::mod_f<std::optional<double>>(6, 5));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X, class Y>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::pi());   //  decltype(rows) is std::vector<double>
     */
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::pi<float>());   //  decltype(rows) is std::vector<float>
     */
    template<class R>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::pow(2, 5));   //  decltype(rows) is std::vector<double>
     */
    template<class X, class Y>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::pow<std::optional<double>>(2, 5));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X, class Y>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::power(2, 5));   //  decltype(rows) is std::vector<double>
     */
    template<class X, class Y>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::power<std::optional<double>>(2, 5));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X, class Y>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::radians(&Triangle::cornerAInDegrees));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::radians<std::optional<double>>(&Triangle::cornerAInDegrees));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::sin(&Triangle::cornerA));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::sin<std::optional<double>>(&Triangle::cornerA));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::sinh(&Triangle::cornerA));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::sinh<std::optional<double>>(&Triangle::cornerA));   //  decltype(rows) is std::vector<std::optional<double>>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::sqrt(25));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::sqrt<int>(25));   //  decltype(rows) is std::vector<int>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::tan(&Triangle::cornerC));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::tan<float>(&Triangle::cornerC));   //  decltype(rows) is std::vector<float>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::tanh(&Triangle::cornerC));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::tanh<float>(&Triangle::cornerC));   //  decltype(rows) is std::vector<float>
     */
    template<class R, class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::trunc(5.5));   //  decltype(rows) is std::vector<double>
     */
    template<class X>
     ...
     *  Example:
     *
     *  auto rows = storage.select(xhsqlite3::trunc<float>(5.5));   //  decltype(rows) is std::vector<float>
     */
    template<class R, class X>
...
namespace xhsqlite3
{
    ...
    namespace internal
    {
        ...
        struct pragma_t
        {
            ...
            xhsqlite3::journal_mode journal_mode()
            {
                return this->get_pragma<xhsqlite3::journal_mode>("journal_mode");
            }

            void journal_mode(xhsqlite3::journal_mode value)
            {
        ...
        private:
            ...
            int _synchronous = -1;
            signed char _journal_mode = -1;  //  if != -1 stores static_cast<xhsqlite3::journal_mode>(journal_mode)
            ...
            void set_pragma(const std::string &name, const xhsqlite3::journal_mode &value, sqlite3 *db = nullptr)
            {
                auto con = this->get_connection();
                if (!db)
                {
...
namespace xhsqlite3
{
    ...
    namespace internal
    {
        ...
        struct storage_base
        {
            ...
            /**
             *  Returns libsqltie3 lib version, not xhsqlite3
             */
    ...
    namespace internal
    {
        ...
        public:
            ...
            void remove_all(Args &&... args)
            {
                ...
                auto statement = this->prepare(xhsqlite3::remove_all<O>(std::forward<Args>(args)...));
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::remove<O>(std::forward<Ids>(ids)...));
                this->execute(statement);
            }
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::update(std::ref(o)));
                this->execute(statement);
            }
            ...
            {
                auto statement = this->prepare(xhsqlite3::update_all(std::move(set), std::forward<Wargs>(wh)...));
                this->execute(statement);
            }
        ...
        protected:
            ...
            std::string group_concat_internal(F O::*m, std::unique_ptr<std::string> y, Args &&... args)
            {
                ...
                if (y)
                {
                    rows = this->select(xhsqlite3::group_concat(m, move(*y)), std::forward<Args>(args)...);
                }
                else
                {
                    rows = this->select(xhsqlite3::group_concat(m), std::forward<Args>(args)...);
                }
                if (!rows.empty())
                {
        ...
        public:
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::get_all<O>(std::forward<Args>(args)...));
            ...
            */
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::get_all<O, R>(std::forward<Args>(args)...));
                return this->execute(statement);
            }
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::get_all_pointer<O>(std::forward<Args>(args)...));
                return this->execute(statement);
            }
            ...
            */
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::get_all_pointer<O, R>(std::forward<Args>(args)...));
                return this->execute(statement);
            }
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::get<O>(std::forward<Ids>(ids)...));
                return this->execute(statement);
            }
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::get_pointer<O>(std::forward<Ids>(ids)...));
                return this->execute(statement);
            }
            ...
            std::optional<O> get_optional(Ids... ids) {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::get_optional<O>(std::forward<Ids>(ids)...));
                return this->execute(statement);
            }
#endif  // SQLITE_ORM_OPTIONAL_SUPPORTED
            ...
            int count(Args &&... args)
            {
                ...
                auto rows = this->select(xhsqlite3::count<R>(), std::forward<Args>(args)...);
                if (!rows.empty())
                {
                    return rows.front();
                }
            ...
            {
                this->assert_mapped_type<O>();
                auto rows = this->select(xhsqlite3::count(m), std::forward<Args>(args)...);
                if (!rows.empty())
                {
                    return rows.front();
                }
            ...
            {
                this->assert_mapped_type<O>();
                auto rows = this->select(xhsqlite3::avg(m), std::forward<Args>(args)...);
                if (!rows.empty())
                {
                    return rows.front();
                }
            ...
            {
                this->assert_mapped_type<O>();
                auto rows = this->select(xhsqlite3::max(m), std::forward<Args>(args)...);
                if (!rows.empty())
                {
            ...
            {
                this->assert_mapped_type<O>();
                auto rows = this->select(xhsqlite3::min(m), std::forward<Args>(args)...);
                if (!rows.empty())
                {
                    return std::move(rows.front());
                }
            ...
            std::unique_ptr<Ret> sum(F O::*m, Args &&... args)
            {
                ...
                std::vector<std::unique_ptr<double>> rows =
                        this->select(xhsqlite3::sum(m), std::forward<Args>(args)...);
                if (!rows.empty())
                {
                    if (rows.front())
                    {
            ...
            {
                this->assert_mapped_type<O>();
                auto rows = this->select(xhsqlite3::total(m), std::forward<Args>(args)...);
                if (!rows.empty())
                {
                    return std::move(rows.front());
                }
            ...
            std::vector<R> select(T m, Args... args)
            {
                ...
                auto statement = this->prepare(xhsqlite3::select(std::move(m), std::forward<Args>(args)...));
                return this->execute(statement);
            }
            ...
            {
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::replace(std::ref(o)));
                this->execute(statement);
            }
            ...
            void replace_range(It from, It to)
            {
                ...
                auto statement = this->prepare(xhsqlite3::replace_range(from, to));
                this->execute(statement);
            }
            ...
            void replace_range(It from, It to, L transformer)
            {
                ...
                auto statement = this->prepare(xhsqlite3::replace_range<T>(from, to, std::move(transformer)));
                this->execute(statement);
            }
            ...
            int insert(const O &o, columns_t<Cols...> cols)
            {
                ...
                static_assert(colsCount > 0, "Use insert or replace with 1 argument instead");
                this->assert_mapped_type<O>();
                auto statement = this->prepare(xhsqlite3::insert(std::ref(o), std::move(cols)));
            ...
            int insert(const O &o)
            {
                ...
                return call_insert_impl_and_catch_constraint_failed([this, &o]() {
                    auto statement = this->prepare(xhsqlite3::insert(std::ref(o)));
                    return int(this->execute(statement));
                });
            }
            ...
            {
                auto statement = this->prepare(xhsqlite3::insert(std::forward<Args>(args)...));
                this->execute(statement);
            }
            ...
            {
                auto statement = this->prepare(xhsqlite3::replace(std::forward<Args>(args)...));
                this->execute(statement);
            }
            ...
            void insert_range(It from, It to)
            {
                ...
                call_insert_impl_and_catch_constraint_failed([this, from, to]() {
                    auto statement = this->prepare(xhsqlite3::insert_range(from, to));
                    this->execute(statement);
                });
            }
            ...
            void insert_range(It from, It to, L transformer)
            {
                ...
                call_insert_impl_and_catch_constraint_failed([this, from, to, transformer = std::move(transformer)]() {
                    auto statement = this->prepare(xhsqlite3::insert_range<T>(from, to, std::move(transformer)));
                    this->execute(statement);
                });
            }
        ...
        public:
             ...
             * submit an issue https://github.com/fnc12/xhsqlite3/issues
            ...
            T execute(const prepared_statement_t<get_t<T, Ids...>> &statement)
            {
                ...
                switch (stepRes)
                {
                    ...
                    case SQLITE_DONE:
                    {
                        throw std::system_error(std::make_error_code(xhsqlite3::orm_error_code::not_found));
                    }
                        break;
                    default:
                    {
